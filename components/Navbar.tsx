    ...
    <nav className="border-b border-white/10 bg-[#071333] text-white">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 sm:px-10 lg:flex-row lg:items-center lg:justify-between lg:px-16">
        ...
        <Link href="/" className="flex items-center gap-2 group w-fit">
          <div className="w-9 h-9 rounded-xl bg-[#456be5] flex items-center justify-center shadow-lg shadow-[#456be5]/30 group-hover:scale-105 transition-transform overflow-hidden shrink-0">
            {siteLogo ? (
              <img src={siteLogo} alt="Campus Connect Logo" className="w-full h-full object-cover" />
            ) : (
