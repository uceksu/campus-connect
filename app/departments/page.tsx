          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {departments.map((dept) => (
              <Link
                ...
                className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 p-8 transition-all hover:bg-slate-50 dark:hover:bg-white/10 hover:border-[#456be5]/50 hover:shadow-lg dark:hover:shadow-2xl dark:hover:shadow-[#456be5]/20 shadow-sm dark:shadow-none"
              >
                ...
                <div>
                  <div className="w-14 h-14 rounded-2xl bg-[#456be5]/10 dark:bg-[#456be5]/20 border border-[#456be5]/20 dark:border-[#456be5]/30 flex items-center justify-center mb-6">
                  ...
                  <p className="text-slate-600 dark:text-slate-500 text-sm line-clamp-3">
                    {dept.description}
                  </p>
                </div>
            ...
            {departments.length === 0 && (
              <div className="col-span-full py-20 text-center">
                <p className="text-slate-500 dark:text-slate-400 text-lg">No departments found.</p>
              </div>
            )}
          </div>
        </div>
